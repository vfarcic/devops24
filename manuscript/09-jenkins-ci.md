...
We will use the "Git tags" approach in the examples that follow. We will also automate generation of release notes, adn attach them to our releases. At least, we will try to do so.
