...
i> For those interested, you can find the Chart Museum API on their [GitHub](https://github.com/helm/chartmuseum#api) page.
...
All in all, we'll continue using Docker Hub for storing container images, and we'll run Chart Museum in our cluster and use it to distribute Helm Charts.
